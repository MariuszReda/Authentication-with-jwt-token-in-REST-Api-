...
namespace Hairdresser.Api.Migrations
{
    ...
    [Migration("20230306141039_PostTag")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Hairdresser.Api.Domain.Post", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Hairdresser.Api.Domain.PostTag", b =>
                {
            ...
            modelBuilder.Entity("Hairdresser.Api.Models.Role", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Hairdresser.Api.Domain.PostTag", b =>
                {
                    b.HasOne("Hairdresser.Api.Domain.Post", "Post")
                        .WithMany()
                        .HasForeignKey("PostId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Hairdresser.Api.Domain.Tag", "Tag")
                        .WithMany()
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
